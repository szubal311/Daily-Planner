...
function timeBlocks() {
  ...
  for (let blockHr = firstEntry; blockHr <= lastEntry; blockHr++) {
    ...
    if (blockHr < currentHour) {
      htmlNew =
        htmlNew +
        '<textarea class="col-md 10 description past" id= "text' +
        timeMapHr[blockHr] +
        '"></textarea>';
    } else if (blockHr === currentHour) {
      htmlNew =
        htmlNew +
        '<textarea class="col-md 10 description present" id= "text' +
        timeMapHr[blockHr] +
        '"></textarea>';
    } else {
      htmlNew =
        htmlNew +
        '<textarea class="col-md 10 description future" id= "text' +
        timeMapHr[blockHr] +
        '"></textarea>';
    }
